(function($) {
    $.selectSuggest = function(target, data,itemSelectFunction) {
		var defaulOption = {
			...
			itemOverBackgroundColor : '#0177dd',//选中背景颜色
        ...
        var _initItems = function(items) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                suggestItem.attr('longitude', items[i].longitude);
                suggestItem.attr('latitude', items[i].latitude);
                ...
                suggestItem.bind("click", itemSelectFunction,function(){
                    //在这里调用地图
                    console.log($("#testInput").val());
                    console.log($(this));

                    var lo = $(this).attr("longitude");
                    var su = $(this).attr("latitude");
                    console.log(lo,su);
                    setPlace(lo,su);
                });
